...
const ProductImage: React.FC<ProductImageProps> = ({
    ...
    return (
        <div className="grid grid-cols-6 gap-2 h-full max-h-[100px] min-h-[100px] sm:min-h-[400px]">
            <div className="flex flex-col items-center justify-center gap-4 cursor-pointer border h-full max-h-[500px] min-h-[300px] 
                ...
                {product.images.map((image: SelectedImgType) => {
                    return (
                        <div key={image.color} onClick={() => handleColorSelect(image)} className={`relative w-[70%] aspect-square 
